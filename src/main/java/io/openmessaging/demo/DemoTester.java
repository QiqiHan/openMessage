...
public class DemoTester {
    ...
    public static void main(String[] args) {
         ...
         */
        properties.put("STORE_PATH", "/Users/mac/Desktop/test");
        ...
        int num = 302400;
        List<Message> messagesForTopic1 = new ArrayList<>(num);
        List<Message> messagesForTopic2 = new ArrayList<>(num);
        List<Message> messagesForQueue1 = new ArrayList<>(num);
        List<Message> messagesForQueue2 = new ArrayList<>(num);
        for (int i = 0; i < num; i++) {
